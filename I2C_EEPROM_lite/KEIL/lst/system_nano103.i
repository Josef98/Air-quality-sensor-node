...
#line 13 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\Nano103\\Source\\system_Nano103.c"
...
#line 14 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\Nano103\\Source\\system_Nano103.c"
...
uint32_t SysGet_HCLKFreq(void)
{
    ...
    if (u32ClkSel == (0x0UL<<(0))) {   
        u32Freqout = (12000000UL);
    } else if(u32ClkSel == (0x1UL<<(0))) {            
        u32Freqout = (32768UL);
    } else if(u32ClkSel == (0x2UL<<(0))) {            
        u32Freqout = SysGet_PLLClockFreq();
    } else if(u32ClkSel == (0x3UL<<(0))) {           
        u32Freqout = (10000UL);
    } else if(u32ClkSel == (0x4UL<<(0))) {           
         
        if(((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL0 & (0x1ul << (3))) {
             
            u32Freqout =(36000000UL);
        } else {
             
            if((((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PWRCTL & (0x1ul << (13))) == (0x1ul << (13)))
                u32Freqout =(16000000UL);
            else
                u32Freqout =(12000000UL);
        }
    } else {         
        u32Freqout = (4000000UL);
    }
...
void SystemInit (void)
{
    ...
    uint32_t u32MyPDID = ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->PDID;
    int i;

    for(i = 0; i < sizeof(u32PDID)/sizeof(uint32_t); i++) {
        if(u32PDID[i] == u32MyPDID) {
            ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->APBCLK |= (0x1ul << (1));
            ((RTC_T *) (((uint32_t)0x40000000) + 0x08000))->RWEN = 0xA965;
            *(unsigned int volatile *)(0x400081F0) = ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->RPDBCLK;
            ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->APBCLK &= ~(0x1ul << (1));
            break;
        }
    }

#line 1 "bst_exp\\bsec_integration.c"
...
#line 78 "bst_exp\\bsec_integration.c"
...
#line 79 "bst_exp\\bsec_integration.c"
...
#line 80 "bst_exp\\bsec_integration.c"
...
#line 82 "bst_exp\\bsec_integration.c"
...
#line 83 "bst_exp\\bsec_integration.c"
...
static bsec_library_return_t bme680_bsec_update_subscription(float sample_rate)
{
    ...
    bsec_sensor_configuration_t required_sensor_settings[(7)];
    uint8_t n_required_sensor_settings = (7);
...
{
    return_values_init ret = {(0), BSEC_OK};
...
#line 253 "bst_exp\\bsec_integration.c"
  ...
  int8_t bme680_status = (0);
    ...
    if (sensor_settings->trigger_measurement)
    {
        ...
        bme680_g.tph_sett.os_temp = sensor_settings->temperature_oversampling;
				...
				bme680_g.gas_sett.heatr_temp = sensor_settings->heater_temperature;  
				bme680_g.gas_sett.heatr_dur  = sensor_settings->heating_duration;  
		
				 
				 
				bme680_g.power_mode = (1u);
				 
				set_required_settings = (1u) | (2u) | (4u) | ((8u) | (64u) | (128u));
    ...
    int32_t bsec_process_data)
{
    ...
    if (bsec_process_data)
    {
        ...
        if (data.status & (0x80u))
        {
            ...
            if (bsec_process_data & (1 << (BSEC_INPUT_PRESSURE - 1)))
            {
            ...
            if (bsec_process_data & (1 << (BSEC_INPUT_TEMPERATURE - 1)))
            {
            ...
            if (bsec_process_data & (1 << (BSEC_INPUT_HUMIDITY-1)))
            {
            ...
            if (bsec_process_data & (1 << (BSEC_INPUT_GASRESISTOR-1)))
            {
                 
                if(data.status & (0x20u))
                {
                    ...
                    state_save_fct state_save, uint32_t save_intvl)
{
    ...
    uint8_t bsec_state[(65)];
    uint8_t work_buffer[(65)];
    ...
    while (1)
    {
        ...
        if (n_samples >= save_intvl)
        {
            ...
            n_samples = 0;
			  ...
			  I2C_MasterReadDataFromSlave(0x18, (0x02), &acc_temp_lsb, 1);
			  
			  Acc_X_LSB = acc_temp_lsb;
				I2C_MasterReadDataFromSlave(0x18, (0x03), &acc_temp_msb, 1);
			  
				Acc_X_MSB = acc_temp_msb;
				
        I2C_MasterReadDataFromSlave(0x18, (0x04), &acc_temp_lsb, 1);
			  
				Acc_Y_LSB = acc_temp_lsb;
			  I2C_MasterReadDataFromSlave(0x18, (0x05), &acc_temp_msb, 1);
			  
				Acc_Y_MSB = acc_temp_msb;
				
				I2C_MasterReadDataFromSlave(0x18, (0x06), &acc_temp_lsb, 1);
			  
				Acc_Z_LSB = acc_temp_lsb;
			  I2C_MasterReadDataFromSlave(0x18, (0x07), &acc_temp_msb, 1);

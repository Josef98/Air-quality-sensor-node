...
uint32_t I2C_Open(I2C_T *i2c, uint32_t u32BusClock)
{
    ...
    u32Clk = I2C_SetBusClockFreq(i2c, u32BusClock);
...
void I2C_Close(I2C_T *i2c)
{
    ...
    if((uint32_t)i2c == (((uint32_t)0x40000000) + 0x20000)) {
        ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IPRST2 |= (0x1ul << (8));
        ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IPRST2 &= ~(0x1ul << (8));
    } else {
        ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IPRST2 |= (0x1ul << (9));
        ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IPRST2 &= ~(0x1ul << (9));
    }
...
{
    uint32_t u32Reg = 0;
    uint32_t u32Val = i2c->CTL & ~(0x08 | 0x04 | 0x02);
...
uint32_t I2C_GetBusClockFreq(I2C_T *i2c)
{
    ...
    if(i2c == ((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))
        return ( CLK_GetPCLK0Freq() / ((u32Divider+1)<<2) );
    else
        return ( CLK_GetPCLK1Freq() / ((u32Divider+1)<<2) );
}
...
uint32_t I2C_SetBusClockFreq(I2C_T *i2c, uint32_t u32BusClock)
{
    ...
    u32Div = (uint32_t) (((u32Pclk * 10)/(u32BusClock * 4) + 5) / 10 - 1);  
    i2c->CLKDIV = u32Div;

...
int32_t  FMC_GetChkSum(uint32_t u32Addr, uint32_t u32Count, uint32_t *u32ChkSum)
{
    ...
    *u32ChkSum = 0;
    ...
    ((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->ISPADDR = u32Addr;
    ((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->ISPDAT  = u32Count;
    ((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->ISPTRG  = (0x1ul << (0));

    while (((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->ISPSTS & (0x1ul << (0))) ;

    if (((((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->ISPCTL & (0x1ul << (6))) ? 1 : 0))
        return -1;
    ...
    *u32ChkSum = ((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->ISPDAT;
    return 0;
}
...
{
    ((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->ISPSTS = 0x80;   

    ((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->ISPCMD = 0x28;
    ((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->ISPADDR    = u32Addr;
    ((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->ISPDAT = u32Count;
    ((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->ISPTRG = (0x1ul << (0));
    ...
    do {
        ((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->ISPCMD = 0x08;
        ((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->ISPADDR    = u32Addr;
        ((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->ISPTRG = (0x1ul << (0));
        while (((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->ISPSTS & (0x1ul << (0))) ;
    }  while (((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->ISPDAT == 0);
    ...
    if ((((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->ISPDAT == 0xA11FFFFF) || (((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->ISPDAT == 0xA1100000))
        return ((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->ISPDAT;
...
int32_t  FMC_SKey_Setup(uint32_t key[3], uint32_t kpmax, uint32_t kemax, int lock_CONFIG)
{
    ...
    if (((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->KEYSTS != 0)
        return -1;

    if (FMC_Erase(0x00301000UL))
        return -2;

    if (FMC_Erase(0x00301000UL+0x200))
        return -2;
    ...
    FMC_Write(0x00301000UL+0x4, key[1]);
    FMC_Write(0x00301000UL+0x8, key[2]);
    FMC_Write(0x00301000UL+0xC, kpmax);
    FMC_Write(0x00301000UL+0x10, kemax);
    FMC_Write(0x00301000UL+0x14, lock_ctrl);

    while (((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->KEYSTS & (0x1ul << (0)));

    if (!(((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->KEYSTS & (0x1ul << (1)))) {
        printf("Security key lock failed!\n");
        return -4;
    }

    if ((lock_CONFIG && !(((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->KEYSTS & (0x1ul << (5)))) ||
            (!lock_CONFIG && (((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->KEYSTS & (0x1ul << (5))))) {
        printf("CONFIG lock failed!\n");
        return -5;
    }

    if (((((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->KPCNT & (0xful << (8))) >> (8)) != kpmax) {
        printf("KPMAX failed!\n");
        return -7;
    }

    if (((((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->KECNT & (0x3ful << (8))) >> (8)) != kemax) {
        printf("KEMAX failed!\n");
        return -8;
    }
    return 0;
...
{
    if (((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->KEYSTS & (0x1ul << (3))) {
    ...
    ((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->KEY0 = key[0];
    ((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->KEY1 = key[1];
    ((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->KEY2 = key[2];
    ((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->KEYTRG = (0x1ul << (0)) | (0x1ul << (1));

    while (((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->KEYSTS & (0x1ul << (0)));

    if (!(((FMC_T *) (((uint32_t)0x50000000) + 0x0C000))->KEYSTS & (0x1ul << (2)))) {

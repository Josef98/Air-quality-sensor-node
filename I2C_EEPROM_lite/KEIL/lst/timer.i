...
void TIMER_EnableCapture(TIMER_T *timer, uint32_t u32CapMode, uint32_t u32Edge)
{
    ...
    timer->CTL = (timer->CTL & ~((0x1ul << (17)) |
                                 (0x1ul << (20)) |
                                 (0x3ul << (18)))) |
                 u32CapMode | u32Edge | (0x1ul << (16));
}
...
void TIMER_EnableEventCounter(TIMER_T *timer, uint32_t u32Edge)
{
    timer->CTL = (timer->CTL & ~(0x1ul << (13))) | u32Edge;
    timer->CTL |= (0x1ul << (12));
}
...
uint32_t TIMER_GetModuleClock(TIMER_T *timer)
{
    ...
    const uint32_t au32Clk[] = {(12000000UL), (32768UL), (10000UL), 0};   

    if(timer == ((TIMER_T *) (((uint32_t)0x40000000) + 0x10000))) {
        u32Src = (((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL1 & (0x7ul << (8))) >> (8);
        u32Div = (((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKDIV1 & (0xful << (8))) >> (8);
    } else if(timer == ((TIMER_T *) (((uint32_t)0x40000000) + 0x10100))) {
        u32Src = (((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL1 & (0x7ul << (12))) >> (12);
        u32Div = (((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKDIV1 & (0xful << (12))) >> (12);
    } else if(timer == ((TIMER_T *) (((uint32_t)0x40100000) + 0x10000))) {
        u32Src = (((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL2 & (0x7ul << (8))) >> (8);
        u32Div = (((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKDIV1 & (0xful << (16))) >> (16);
    } else {
        u32Src = (((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL2 & (0x7ul << (12))) >> (12);
        u32Div = (((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKDIV1 & (0xful << (20))) >> (20);
    }
    u32Div++;
    if(u32Src < 4)
        ...
        if(((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL0 & (0x1ul << (3))) {
            ...
            return (36000000UL) / u32Div;
        } else {
             
            if(((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PWRCTL & (0x1ul << (13)))
                return (16000000UL) / u32Div;
            else
                return (12000000UL) / u32Div;
        }

    } else if(u32Src == 5) { 
        return (4000000UL) / u32Div;
                             ...
                             uint32_t u32EnableInt)
{
    ...
    timer->ECTL = u32DropCount << (24);
    t = (timer == ((TIMER_T *) (((uint32_t)0x40000000) + 0x10000))) ? ((TIMER_T *) (((uint32_t)0x40000000) + 0x10100)) : ((TIMER_T *) (((uint32_t)0x40100000) + 0x10100));

    t->CMP = u32Timeout;
    t->INTEN = u32EnableInt ? (0x1ul << (1)) : 0;
    timer->CTL = mode | (0x1ul << (0));
...
void TIMER_SetTriggerSource(TIMER_T *timer, uint32_t u32Src)
{
    timer->CTL = (timer->CTL & ~(0x1ul << (11))) | u32Src;
}
...
void TIMER_SetTriggerTarget(TIMER_T *timer, uint32_t u32Mask)
{
    timer->CTL = (timer->CTL & ~((0x1ul << (28)) | (0x1ul << (10)) | (0x1ul << (8)))) | u32Mask;
}
